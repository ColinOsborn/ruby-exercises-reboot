...
class StringTest < Minitest::Homework
  ...
  def test_squeeze
    # removes the duplicates - default
    # removes duplicated(o) or whichever is specified
  ...
  def test_strip
    # strips down a string in either direction you specify
  ...
  def test_next
    # goes to the next character or integer in line
